...
const Login = () => {
    ...
    const {signIn, signGoogle} = useContext(firecontext)
    ...
    return (
        ...
        <div className="  animate__animated   animate__flip animate__repeat-2      w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gradient-to-r from-orange-600  to-yellow-400 text-gray-100">
                ...
                <p className="text-sm text-center  text-black ">Don't have account?
                    
                    <Link to="/up" >
                    <a   className="focus:underline hover:underline text-black ">Sign up here</a>
                    </Link> 
